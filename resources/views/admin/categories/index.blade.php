                ...
                <div class="bg-dark rounded-3 p-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <a href="{{ route('admin.categories.create') }}" class="btn btn-primary btn-sm">Crear</a>
                                    ...
                                    @foreach($categories as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.categories.destroy', $cat) }}" method="POST" style="display:inline-block" class="needs-confirm" data-confirm-title="Eliminar categoría #{{ $cat->id }}" data-confirm-message="¿Eliminar la categoría '{{ addslashes($cat->name) }}' (ID #{{ $cat->id }})? Esta acción no se puede deshacer." data-confirm-button="Eliminar">
                                                    @csrf
                                                    @method('DELETE')
